	...
	<div class="context">
		...
		<div class="container">
			<div class="formheader">
				<h3><span style = "color: #128C7E;">Client </span>| Sign Up</h3>
			</div>
			<form class="form" action="SignUpClientCheck.php" onsubmit="return validateForm()" method="post" >
				<input type="" placeholder="ClientID" id="clientid" name="clientid" required>
				<br>
				...
				<br>
				<input type="" placeholder="Address" id="address" name="address" required>
				<br>
				<input type="" placeholder="Country" id="country" name="country" required>
				<br>
