...
include(__DIR__ . '/../dbConnect.php');
	...
	if(isset($_POST['addOrchard'])) {
		...
		$sql = "INSERT INTO orchard(OrchardID, Address, Lattitude, Longitude)
				VALUES('$count', '$address', '$latitude', '$longitude')";
	...
	<div class = "container">
		...
		<div class = "main">
			...
			<ul>
				...
				<li>
					<a href = "addOrchard.php" style = "font-weight: bold;">Add Orchard</a>
				</li>
			</ul>
			...
			<form method = "POST">
				...
				<div class = "form-control">
					...
					<label>Orchard Latitude: </label>
					<input type = "text" name = "latitude" id = "latitude" required>
					<small>Invalid</small>
				</div>
				<div class = "form-control">
					<i class="fa fa-map-pin"></i>
					<label>Orchard Longitude: </label>
					<input type = "text" name = "longitude" id = "longitude" required>
					<small>Invalid</small>
				</div>
				<div class = "form-control">
					<input type = "submit" name = "addOrchard" value = "Submit"></input>
				</div>
			</form>
		</div>
	</div>
