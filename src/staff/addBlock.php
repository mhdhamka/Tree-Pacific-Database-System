...
include(__DIR__ . '/../dbConnect.php');
	...
	if(isset($_POST['addBlock'])) {
		...
		$sql = "INSERT INTO block(BlockID, BasePrice, OrchardID)
				VALUES('$count', '$baseprice', '$orchardID')";
	...
	<div class = "container">
		...
		<div class = "main">
			...
			<ul>
				...
				<li>
					<a href = "addBlock.php" style = "font-weight: bold;">Add Block</a>
				</li>
			</ul>
			...
			<form method = "POST">
				<div class = "form-control">
					...
					<input type = "text" name = "baseprice" id = "baseprice" required>
					<small>Invalid</small>
				</div>
				<div class = "form-control">
					<i class="fa fa-tree"></i>
					<label>Orchard ID: </label>
					<input type = "text" name = "orchardID" id = "orchardID" required>
					<small>Invalid</small>
				</div>
				<div class = "form-control">
					<input type = "submit" name = "addBlock" value = "Submit"></input>
				</div>
			</form>
		</div>
	</div>
