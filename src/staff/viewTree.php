	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					<li>
						<a href = "viewTree.php" style = "font-weight: bold;">Trees</a>
					</li>
				</ul>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['BlockID']."</td>
											<td>
												<button><a href=\"updateTree.php?updateID=$row[TreeID]\">Update</a></button>
												<button><a href=\"deleteTree.php?deleteID=$row[TreeID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addTree.php">Add Tree</button>
				</div>
				<br>
				<ul>
					<li>
						<a href = "viewTree.php" style = "font-weight: bold;">Tree Update</a>
					</li>
				</ul>
				...
				<table>
					<thead>
						<tr>
							...
							<th scope = "col">Tree Height</th>
							<th scope = "col">Tree Diameter</th>
							<th scope = "col">Tree Status</th>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['TreeDiameter']."</td>
											<td>".$row['TreeStatus']."</td>
											<td>".$row['UpdateDate']."</td>
											<td>
												<button><a href=\"deleteTreeUpdate.php?deleteID=$row[UpdateID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
