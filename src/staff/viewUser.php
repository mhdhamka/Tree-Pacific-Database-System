	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['UserType']."</td>
											<td>
												<button><a href=\"updateUser.php?updateID=$row[UserID]\">Update</a></button>
												<button><a href=\"deleteUser.php?deleteID=$row[UserID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addUser.php">Add User</button>
				</div>
				<br>
				<ul>
					<li>
						<a href = "viewUser.php" style = "font-weight: bold;">Client</a>
					</li>
				</ul>
				<table>
					<thead>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['Country']."</td>
											<td>
												<button><a href=\"updateClient.php?updateID=$row[UserID]\">Update</a></button>
												<button><a href=\"deleteClient.php?deleteID=$row[UserID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addClient.php">Add Client</button>
				</div>
				<br>
				<ul>
					<li>
						<a href = "viewUser.php" style = "font-weight: bold;">Staff</a>
					</li>
				</ul>
				<table>
					<thead>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['Salary']."</td>
											<td>
												<button><a href=\"updateStaff.php?updateID=$row[UserID]\">Update</a></button>
												<button><a href=\"deleteStaff.php?deleteID=$row[UserID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addStaff.php">Add Staff</button>
				</div>
			</div>
		</div>
	</div>
