...
<?php
	...
	{	
		...
		global $conn;
		$sql = "UPDATE orchard SET Address = '$address', Lattitude = '$latitude', Longitude = '$longitude' WHERE OrchardID = $updateID";
		...
		$sql = "INSERT INTO managementhistory (ManageID, OrchardID, UserID, ManageDate)
				VALUES ('$count', '$updateID', '$userID', NOW())";
		$result = mysqli_query($conn, $sql);
		header("Location:viewOrchard.php");
	}
	...
	<div class = "container">
		<div class = "sidebar" id = "sidebar">
			<ul>
				...
				<li>
					<a class = "active" href = "viewOrchard.php">
		...
		<div class = "main">
			...
			<ul>
				<li>
					<a href = "viewOrchard.php">Orchards</a>
				</li>
				<li>
					<p> >> </p>
				</li>
				<li>
					<a style = "font-weight: bold;">Update Orchard</a>
				</li>
			</ul>
			...
			<form method = "POST">
				<div class = "form-control">
					...
					<label><?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT OrchardID FROM orchard WHERE OrchardID = $updateID";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Address FROM orchard WHERE OrchardID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Lattitude FROM orchard WHERE OrchardID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Longitude FROM orchard WHERE OrchardID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					<input type = "submit" name = "updateOrchard" value = "Update"></input>
				</div>
			</form>
		</div>
	</div>
