...
<?php
	...
	$sql="SELECT Username FROM user WHERE UserID='$Userid' AND PasswordHash='$PasswordHash' AND UserType = 'S'";
	...
	if($count==1) {
		...
		$sql = "UPDATE user SET LogStatus = 1 WHERE UserID = $Userid";
		$result = mysqli_query($conn, $sql);
...
<head>
	...
	<link rel="iconn" type="image/x-iconn" href="/tree/public/img/tree.PNG">
	<style type="text/css">
		.header{
			display: flex;
			padding: 5px;
 	...
 	<div class="conntext">
		...
		<div class="conntainer">
			<div class="formheader">
				<h3><span style = "color: #128C7E;">Staff</span>| Log In</h3>
			</div>
			<form class="form" method="POST" action="<?php ($_SERVER['PHP_SELF']) ?>">
				<br>
				<input type="text" placeholder="StaffID" id="userid" name="userid" required>
				<br>
			...
			<div class="formfooter">
				...
				<a href="SignUpStaff.php">Sign Up</a>
				</p>
			</div>
		</div>
	</div>
