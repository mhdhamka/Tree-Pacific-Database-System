	...
	<div class = "container">
		...
		<div class = "main">
			...
			<ul>
				...
				<li>
					<a style = "font-weight: bold;">Update Client</a>
				</li>
			</ul>
			...
			<form method = "POST">
				...
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Address FROM client WHERE UserID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Country FROM client WHERE UserID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					<input type = "submit" name = "updateClient" value = "Update"></input>
				</div>
			</form>
		</div>
	</div>
