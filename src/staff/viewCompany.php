	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					<li>
						<a href = "viewCompany.php" style = "font-weight: bold;">Companies</a>
					</li>
				</ul>
				...
				<table>
					<thead>
						<tr>
							...
							<th scope = "col">Company Orchard</th>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['OrchardID']."</td>
											<td>
												<button><a href=\"updateCompany.php?updateID=$row[CompanyID]\">Update</a></button>
												<button><a href=\"deleteCompany.php?deleteID=$row[CompanyID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addCompany.php">Add Company</button>
				</div>
			</div>
		</div>
	</div>
