	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					<li>
						<a href = "viewOrchard.php" style = "font-weight: bold;">Orchards</a>
					</li>
				</ul>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['Longitude']."</td>
											<td>
												<button><a href=\"updateOrchard.php?updateID=$row[OrchardID]\">Update</a></button>
												<button><a href=\"deleteOrchard.php?deleteID=$row[OrchardID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addOrchard.php">Add Orchard</button>
				</div>
				<br>
				<ul>
					<li>
						<a href = "viewOrchard.php" style = "font-weight: bold;">Orchard Management History</a>
					</li>
				</ul>
				<table>
					<thead>
						<tr>
							<th scope = "col">Manage ID</th>
							<th scope = "col">Orchard ID</th>
							<th scope = "col">UserID</th>
							<th scope = "col">Manage Date</th>
						</tr>
					</thead>
					<tbody>
						<?php
