	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					<li>
						<a href = "viewSale.php" style = "font-weight: bold;">Sales</a>
					</li>
				</ul>
							...
							if(mysqli_num_rows($result)>0)
							{
								...
								while($row=mysqli_fetch_assoc($result))
								{
									...
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$realname."</td>
											<td>
												<button><a href=\"reassignBlock.php?updateID=$row[UserID]&saleID=$row[SaleID]&blockID=$row[BlockID]\">Reassign</a></button>
											</td>
										  </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "assignBlock.php">Assign Block</button>
				</div>
			</div>
		</div>
	</div>
