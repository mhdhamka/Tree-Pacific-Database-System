		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					...
					<li>
						<a style = "font-weight: bold;">Reassign Block</a>
					</li>
				</ul>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									...
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$realname."</td>
											<td>
												<button><a href=\"assignBlock.php?updateID=$row[UserID]&saleID=$row[SaleID]&blockID=$row[BlockID]\">Reassign</a></button>
											</td>
										  </tr>";
								}
							}
				...
				<form method = "POST">
					...
					<div class = "form-control">
						<input type = "submit" name = "reassignBlock" value = "Update"></input>
					</div>
				</form>
			</div>
		</div>
