	...
	<div class = "sidebarcontainer">
		...
		<div class = "main">
			...
			<div class = "display-accounts">
				<ul>
					<li>
						<a href = "viewBlock.php" style = "font-weight: bold;">Blocks</a>
					</li>
				</ul>
							...
							if ($result -> num_rows > 0)
							{
								while ($row = $result -> fetch_assoc())
								{
									echo "<tr style = 'text-align: center;'>
											...
											<td>".$row['OrchardID']."</td>
											<td>
												<button><a href=\"updateBlock.php?updateID=$row[BlockID]\">Update</a></button>
												<button><a href=\"deleteBlock.php?deleteID=$row[BlockID]\">Delete</a></button>
											</td>
										 </tr>";
								}
							}
				...
				<div class = "addbutton">
					<button><a href = "addBlock.php">Add Block</button>
				</div>
			</div>
		</div>
	</div>
