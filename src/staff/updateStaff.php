	...
	<div class = "container">
		...
		<div class = "main">
			...
			<ul>
				...
				<li>
					<a style = "font-weight: bold;">Update Staff</a>
				</li>
			</ul>
			...
			<form method = "POST">
				<div class = "form-control">
					...
					<label><?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT UserID FROM staff WHERE UserID = $updateID";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					...
					<label><?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT EmployDate FROM staff WHERE UserID = $updateID";
												$result = mysqli_query($conn, $sql);
										  ...
										  ?></label>
					<input type = "date" name = "employdate" id = "employdate">
					<small>Invalid</small>
				</div>
				<div class = "form-control">
					...
					<input type = "text"
						   ...
						   value = "<?php $updateID = $_GET['updateID'];
												global $conn;
												$sql = "SELECT Salary FROM staff WHERE UserID = $updateID;";
												$result = mysqli_query($conn, $sql);
				...
				<div class = "form-control">
					<input type = "submit" name = "updateStaff" value = "Update"></input>
				</div>
			</form>
		</div>
	</div>
